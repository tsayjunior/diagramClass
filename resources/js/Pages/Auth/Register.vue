				...
				<div class="w-full">
					...
					<form @submit.prevent="submit">
						...
						<div>
							...
							<TextInput id="lastname" type="text" class="block w-full mt-1" v-model="form.lastname" required autofocus autocomplete="lastname" />
						...
						<div>
							<InputLabel for="c_i" value="c.i." />
							<TextInput id="c_i" type="text" class="block w-full mt-1" v-model="form.ci" required autofocus autocomplete="c_i" />
						...
						<div class="mt-4">
							<InputLabel for="type_user" value="Tipo de usuario" />
							<TextInput id="type_user" type="text" class="block w-full mt-1" v-model="form.type_user" required autocomplete="username" />
